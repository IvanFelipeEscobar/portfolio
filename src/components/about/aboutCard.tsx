const AboutCard = () => {
  return (
    <div className="card bg-base-300 bg-opacity-35 sm:w-3/4 max-h-[600px]  mb-10 pl-2 pb-10 relative">
    <div className="py-4">
      <h2 className="text-neutral text-center text-5xl font-extrabold tracking-wide">
        Hey! I'm Felipe
      </h2>
    </div>

    <div className="overflow-y-scroll  text-balance font-serif text-neutral pt-8 ">
      ...
      <p>
        ...
        transitioned from a fulfilling 15-year career in automotive repair, modifications and maint. My
        passion for problem-solving and building led me to the world of web
        development, where I honed my skills through a rigorous Flex Full
        Stack Web Development Bootcamp at the Georgia Institute of
        Technology.
      </p>
      ...
      <h3>Modern Web Development Tools and Technologies</h3>
      <br />
      <p>
    ...
    <div className="absolute right-20 bottom-2 italic text-accent">...Scroll to continue reading</div>
  </div>
  )
}
